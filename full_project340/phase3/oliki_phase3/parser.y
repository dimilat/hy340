...
returnstmt: RETURN{afterAssign = 0; inReturn = 1; if(!infunc){yyerror("Use of 'return' while not in a function");}} expr  SEMICOLON { inReturn = 1; emit(ret, $3, (expr *) 0, (expr *) 0,currQuad, yylineno); }
